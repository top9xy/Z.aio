        ...
        public int Radius
        {
            get
            {
                return !AddHitbox
                    ...
                    : EvadeManager.SkillShotsExtraRadius + _radius + (int)GameObjects.AllyHeroes.FirstOrDefault(x => x.Distance(ObjectManager.Player) < Z.aio.Common.Champion.E.Range).BoundingRadius;
            }
            set { _radius = value; }
        }
